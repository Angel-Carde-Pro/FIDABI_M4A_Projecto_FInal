        ...
        btnacept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(txtcorreo.getText().toString()) || TextUtils.isEmpty(txtpassword.getText().toString())) {
                    Toast.makeText(Activity_Listar.this, "Correo/Contraseña son necesarios", Toast.LENGTH_LONG).show();
        ...
        loginResponseCall.enqueue(new Callback<LoginResponse>() {
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                ...
                if (response.isSuccessful()) {
                    Intent intent = new Intent(Activity_Listar.this, Activity_Home.class);

                    Toast.makeText(Activity_Listar.this, "Login Correcto", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Activity_Listar.this, "Login Fallo", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<LoginResponse> call, Throwable t) {
                Toast.makeText(Activity_Listar.this, "El usuario/contraseña son incorrectos", Toast.LENGTH_SHORT).show();
            }
        });
